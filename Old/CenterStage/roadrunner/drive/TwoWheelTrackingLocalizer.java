package org.firstinspires.ftc.teamcode.CenterStage.roadrunner.drive;
...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PERPENDICULAR_Y = -1.37;
    
    public static double X_MULTIPLIER = 0.492; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.482; // Multiplier in the Y direction
