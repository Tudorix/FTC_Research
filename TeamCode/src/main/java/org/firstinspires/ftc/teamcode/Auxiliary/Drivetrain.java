package org.firstinspires.ftc.teamcode.Auxiliary;
...
public class Drivetrain {
    ...
    public void power(double output){
        topLeftDriveMotor.setPower(topLeftDriveMotor.getPower() -output);
        bottomLeftDriveMotor.setPower(bottomLeftDriveMotor.getPower() -output);
        topRightDriveMotor.setPower(topRightDriveMotor.getPower() + output);
        bottomRightDriveMotor.setPower(bottomRightDriveMotor.getPower() + output);
    }
